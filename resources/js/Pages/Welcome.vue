<template>
  ...
  <div>
    <div class="container-fluid fixed-top p-4 bg-gray">
      <div class="col-12">
        <div v-if="canLogin" class="d-flex justify-content-end">
          <div>
            <Link v-if="$page.props.user" :href="route('dashboard')" class="text-lime">
              Dashboard
            </Link>

            <template v-else>
              <Link :href="route('login')" class="text-lime">
                Log in /
              </Link>

              <Link v-if="canRegister" :href="route('register')" class="ms-4 text-lime">
                Register
              </Link>
            </template>
          </div>
